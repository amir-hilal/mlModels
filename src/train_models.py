...
def load_and_process_data(filepath):
    ...
    feature_columns = ['Reviews', 'Size', 'Price', 'last_updated_year', 'last_updated_month', 'Category_encoded', 'Type_Free', 'Type_Paid']  # Add or remove features as needed
...
def train_and_log_model(X, y, model, model_name, target_name):
    ...
    with mlflow.start_run(run_name=model_name):
        ...
        # For tree-based models, log feature importances
